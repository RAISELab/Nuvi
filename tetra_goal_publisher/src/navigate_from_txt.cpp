...
public:
    GoalNavigator() : Node("goal_navigator")
    {
        ...
        if (!readGoalFromFile("/home/mimiz/ros2_ws/src/Capstone/tetra_goal_publisher/config/destinations.txt", target_pose_))
        {
...
private:
    ...
    {
        std::ifstream file("/home/mimiz/ros2_ws/src/Capstone/tetra_goal_publisher/config/destinations.txt");
        if (!file.is_open())
        {
