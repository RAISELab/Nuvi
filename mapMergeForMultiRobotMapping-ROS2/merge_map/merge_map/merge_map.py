...
class MergeMapNode(Node):
    def __init__(self):
        ...
        self.subscription = self.create_subscription(OccupancyGrid, '/rtabmap/map', self.map1_callback, qos_transient)
        self.subscription = self.create_subscription(OccupancyGrid, '/projected_map', self.map2_callback, qos_transient)
        self.map1 = None
        self.map2 = None
